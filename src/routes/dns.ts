...
router.get("/:domain/records", async (req, res) => {
  ...
  try {
    ...
    if (data.status === "SUCCESS") {
      ...
      console.error("Porkbun API Error (Retrieve):", data.message || data);
...
router.post("/:domain/records", async (req, res) => {
  ...
  try {
    ...
    if (data.status === "SUCCESS") {
      ...
      console.error("Porkbun API Error (Create):", data.message || data);
...
router.delete("/:domain/records/:id", async (req, res) => {
  ...
  try {
    ...
    if (data.status === "SUCCESS") {
      ...
      console.error("Porkbun API Error (Delete):", data.message || data);
